...
func (r *Fernsehserien) Handle(m *signalcli.Message, signal signalsender.SignalSender, virtRcv func(*signalcli.Message)) {
	// parse the message
	var args Args
...
func (r *Fernsehserien) Close(virtRcv func(*signalcli.Message)) {
