...
func NewFetcher(log *slog.Logger, loc *time.Location, timeout time.Duration) *Fetcher {
	f := &Fetcher{
		...
		timeout: timeout,
		senderScrapers: []subFetcher{
			scrapers.NewVox(scrapers.NewScraperBase(log, "vox", loc)),
			scrapers.NewRtl(scrapers.NewScraperBase(log, "rtl", loc)),
			scrapers.NewRtl2(scrapers.NewScraperBase(log, "rtl2", loc)),

			scrapers.NewSatEins(scrapers.NewScraperBase(log, "sat1", loc), "https://www.sat1.de/tv-programm"),
			scrapers.NewSatEins(scrapers.NewScraperBase(log, "prosieben", loc), "https://www.prosieben.de/tv-programm"),
			scrapers.NewSatEins(scrapers.NewScraperBase(log, "kabeleins", loc), "https://www.kabeleins.de/tv-programm"),

			scrapers.NewArd2(scrapers.NewScraperBase(log, "br", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=br"),
			scrapers.NewArd2(scrapers.NewScraperBase(log, "ndr", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=ndr"),
			scrapers.NewArd2(scrapers.NewScraperBase(log, "ard", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=daserste"),
			scrapers.NewArd2(scrapers.NewScraperBase(log, "arte", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=arte"),
			scrapers.NewArd2(scrapers.NewScraperBase(log, "alpha", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=alpha"),
			scrapers.NewArd2(scrapers.NewScraperBase(log, "one", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=one"),
			scrapers.NewArd2(scrapers.NewScraperBase(log, "wdr", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=wdr"),
			scrapers.NewArd2(scrapers.NewScraperBase(log, "swr", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=swr"),
			scrapers.NewArd2(scrapers.NewScraperBase(log, "3sat", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=3sat"),
			scrapers.NewArd2(scrapers.NewScraperBase(log, "hr", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=hr"),
			scrapers.NewArd2(scrapers.NewScraperBase(log, "phoenix", loc), "https://programm-api.ard.de/program/api/program?mode=channel&channelIds=phoenix"),
