...
//	Handle(m *signaldbus.Message, signal signalsender.SignalSender, sendError func(err error) bool)
// }
...
func (c *Cmd) Handle(m *signaldbus.Message, signal signalsender.SignalSender) {
